...
export const recipes = [
  {
    ...
    ingredients: [
      ...
      "Gandham Spices Biryani Marination Mix – 6 tbsp (entire pack)",
      "Ginger-garlic paste – 2½ tbsp",
      "Ghee – 2 tbsp (for marination) + 3–4 tbsp (for cooking)",
      "Fresh mint leaves – a handful",
      "Fresh coriander leaves – a handful",
      "Onion – 4–5 large, thinly sliced",
      "Basmati Rice – 3 glasses (~750 g), washed & soaked",
      "Water – as required",
    ],
    name: "Biryani Marination Mix",
    instructionsImage: biryaniGroundedImg,
    stepsHeadings: ["The Marination", "The Cooking"],
    steps: [
      "Marinate 1 KG chicken with 2 packs of curd, salt to taste, 1 tbsp chilli powder, 6 tbsp (the entire pack) of Gandham Spices Biryani Marination Mix, 2½ tbsp ginger-garlic paste, 2 tbsp ghee, and fresh mint & coriander leaves. Rest for 30 mins (until then fry the onions).",
      "Heat 3–4 tbsp ghee in a large aluminum or heavy-bottomed pot. Fry 4–5 thinly sliced onions until golden brown. Keep half of the fried onions aside for garnish. Add the marinated chicken to the pot and cook until it starts boiling. Adjust salt and spice to your preference. Add 3 glasses (~750 g) of washed & soaked Basmati Rice to the pot, along with the required amount of water as per your standard cooking method. (Note: Chicken can release water while cooking). Mix gently. Top with the reserved fried onions, fresh mint, and coriander. Close the lid tightly, and cook on a low flame until the rice is perfectly done. Rest for 10 minutes, fluff gently, and serve hot!",
    ],
  },
  {
    id: "rasam",
