...
export const recipes = [
  {
    ...
    ingredients: [
      ...
      "Biryani Marination Mix – 3 tbsp",
      "Ginger-garlic paste – 1½ tbsp",
      "Ghee – 1 tbsp (for marination) + 2–3 tbsp (for cooking)",
      "Mint leaves – few",
      "Coriander leaves – few",
      "Onion – 3–4 medium, thinly sliced",
      "Rice – 1½ glass (~375 g), washed & soaked",
      "Water – as required",
    ],
    name: "Biryani Marination Mix",
    instructionsImage: biryaniGroundedImg,
    steps: [
      "Marinate 500 g chicken with 500 ml curd, salt to taste, 1 tbsp chilli powder, 3 tbsp Biryani Marination Mix, 1½ tbsp ginger-garlic paste, 1 tbsp ghee, mint & coriander leaves. Rest for 1 hour.",
      "Heat 2–3 tbsp ghee in an aluminum pot. Fry 3–4 sliced onions till golden. Keep half the fried onions aside.",
      "Add marinated chicken and cook till it starts boiling. Adjust salt & spice.",
      "Add 1½ glass (~375 g) washed & soaked rice to the pot, along with the required amount of water as per your cooking method. Top with fried onions, mint & coriander. Mix gently. Close the lid and cook till the rice is done. Rest & serve hot.",
    ],
  },
  {
    id: "rasam",
